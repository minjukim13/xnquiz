...
const INPUT_CLS = "w-full text-sm px-3 py-2 rounded-md border border-border bg-white focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-[#3182F6] transition-all"
          ...
          <div className="lg:col-span-2 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" onClick={() => setShowAddModal(true)} className="bg-[#3182F6] hover:bg-[#1B64DA]"><Plus size={13} />직접 추가</Button>
              </div>
            </div>
            {questions.length === 0 ? (
              <div className="p-12 text-center rounded-md border-2 border-dashed border-border bg-slate-50">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <Button size="sm" onClick={() => setShowAddModal(true)} className="bg-[#3182F6] hover:bg-[#1B64DA]">직접 추가</Button>
                </div>
              </div>
            ) : (
...
function Tgl({ checked, onChange, label }) { return <label className="flex items-center gap-2.5 cursor-pointer"><Switch checked={checked} onCheckedChange={onChange} className="data-[state=checked]:bg-[#3182F6]" /><span className="text-sm text-slate-700">{label}</span></label> }
