...
export default function QuizEdit() {
  ...
  }, [questions, initialQuestionsSnapshot, title, description, quiz?.title, quiz?.description, assignments, initialAssignmentsSnapshot])
