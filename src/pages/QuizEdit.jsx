...
import { Plus, GripVertical, Trash2, Settings2, Pencil, Printer, AlertCircle, RefreshCw } from 'lucide-react'
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto pb-6">
        <div className="flex items-center justify-between gap-3 pt-3 pb-4 border-b border-gray-200 mb-6">
