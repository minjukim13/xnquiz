...
import { getQuizDefaultsForForm } from '@/utils/quizGlobalSettings'
...
export default function QuizCreate() {
  ...
  return (
    <>
      <div className="pb-4">
        <div className="flex items-center justify-between gap-3 pt-6 sm:pt-8 pb-4 sm:pb-5">
          <h1 className="text-[20px] sm:text-[22px] font-bold text-foreground">새 퀴즈 만들기</h1>
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-sm font-medium text-secondary-foreground">학생에게 공개</span>
            <TooltipProvider><Tooltip><TooltipTrigger asChild><HelpCircle size={14} className="text-muted-foreground cursor-help" /></TooltipTrigger><TooltipContent side="top" sideOffset={4}><p>공개 시 저장 후 학생이 즉시 응시할 수 있습니다.<br />임시저장은 비공개 상태에서만 가능합니다.</p></TooltipContent></Tooltip></TooltipProvider>
