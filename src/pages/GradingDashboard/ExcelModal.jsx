          ...
          {step === 'error' && (() => {
            ...
            return (
              <div className="rounded border border-red-200">
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-red-200 bg-destructive-soft">
                  <span className="text-xs font-semibold text-destructive">업로드 실패</span>
                  <span className="text-xs truncate max-w-[200px] text-destructive" title={fileName}>{fileName}</span>
                </div>
